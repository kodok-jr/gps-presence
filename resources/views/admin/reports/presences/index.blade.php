<x-larapattern-layout>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6">
            <form action="{{ route('administrator.reports.presence.store') }}" method="POST" target="_blank">
                @csrf
                <div class="card card-default">
                    <div class="card-header card-header-border-bottom">
                        <h2>Report Presences</h2>
                    </div>
                    <div class="card-body pb-0 pt-2">
                        ...
                        <label class="text-dark font-weight-medium" for="">Student</label>
                        <div class="input-group input-group-sm">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="inputGroup-sizing-sm">
                            ...
                            {{-- <input type="text" class="form-control" aria-label="Small" placeholder="Small Size" aria-describedby="inputGroup-sizing-sm"> --}}
                            <select id="user_id" name="user_id" class="form-control custom-select2-user form-control-sm">
                                <optgroup label="Please choose a student">
                                    <option value=""></option>
