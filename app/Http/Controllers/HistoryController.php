...
class HistoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('web.histories.index', compact('presence_today', 'month_name'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return view('web.histories._partials.scrollable', compact('histories'));
    }
